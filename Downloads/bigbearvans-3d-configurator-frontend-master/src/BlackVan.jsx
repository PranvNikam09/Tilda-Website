...
const Van_Black = lazy(() => import("./components/van-models/BlackVan"));
  ...
  return (
    <div className="container-fluid">
      ...
      <div className="row d-flex">
        ...
        <div className="ccol-xl-4 col-lg-4 col-md-4 col-sm-4 d-flex justify-content-center align-items-center">
