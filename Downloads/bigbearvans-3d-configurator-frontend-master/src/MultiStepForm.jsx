...
const MultiStepForm = ({
  ...
  // --- UI Starts Here ---
  return (
    <div className="sidebar d-flex flex-column position-relative">
      {/* Tab Buttons */}
      ...
      <div className="mb-2 px-3 pt-3">
        <h2 className="fs-5 fw-bold mb-1 section-title text-light">
          {steps[currentStep][0].replace(/-/g, " ")}
        </h2>
        <p className="mb-3 section-desc text-light">
              ...
              <div key={model.label} className="col-12 mb-3">
                ...
                >
                  ...
                  <div className="card-content p-2">
                    ...
                    {model.description && (
                      <p className="mb-0 card-desc text-dark">{model.description}</p>
                    )}
                  </div>

                  {/* Optional badge for selected state */}
      ...
      <div className="sticky-bottom-nav bg-white text-dark p-3 shadow-lg">
        <div className="d-flex justify-content-between align-items-center flex-wrap gap-2">
          ...
          {activeTab === "exterior" && currentStep === 0 ? (
            <button
              className="btn p-2 fw-semibold btn-nav-alt btn-dark text-light"
              onClick={() => {
            ...
            <button
              className="btn p-0 fw-semibold btn-nav"
              onClick={goToPrevStep}
              disabled={currentStep === 0}
            >
              <i class="arrow-icon fas fa-chevron-circle-left"></i>
            </button>
          )}

          <div className="text-center">
            <button
              className="btn btn-success btn-lg fw-bold shadow-sm w-100 btn-quote mt-0"
          ...
          {activeTab === "interior" && currentStep === steps.length - 1 ? (
            <button
              className="btn p-2 exterior-btn btn-dark text-light fw-semibold btn-next"
              onClick={() => {
                toggleExterior(true);
                setActiveTab("exterior");
                setCurrentStep(0);
            ...
            <button
              className=" btn-dark text-light btn p-2 fw-semibold btn-next"
              onClick={() => {
                setActiveTab("system");
                setCurrentStep(0);
              }}
            ...
            <button
              className="btn p-0 fw-semibold btn-done"
              disabled
            >
              Done
            </button>
            ...
            >
              <i class="arrow-icon fas fa-chevron-circle-right"></i>
            </button>
          )}
        </div>
