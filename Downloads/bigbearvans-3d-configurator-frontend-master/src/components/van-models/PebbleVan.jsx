...
export default function Van_Pebble({ hidePartsWhenFacingCamera, showExterior }) {
  const { nodes, materials } = useGLTF('./models/AllColorGLB144/Van_Pebble.glb')
...
useGLTF.preload('./models/AllColorGLB144/Van_Pebble.glb')