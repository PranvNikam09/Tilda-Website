...
export default function Van_GraphiteGrey({ hidePartsWhenFacingCamera, showExterior }) {
  const { nodes, materials } = useGLTF('./models/AllColorGLB144/Van_GraphiteGrey.glb')
...
useGLTF.preload('./models/AllColorGLB144/Van_GraphiteGrey.glb')