...
export default function Van_Black({ hidePartsWhenFacingCamera, showExterior }) {
  const { nodes, materials } = useGLTF('./models/AllColorGLB144/Van_Black.glb')
...
useGLTF.preload('./models/AllColorGLB144/Van_Black.glb')
