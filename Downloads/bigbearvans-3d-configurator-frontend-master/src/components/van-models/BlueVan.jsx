...
export default function Van_BlueGrey({ hidePartsWhenFacingCamera, showExterior }) {
  const { nodes, materials } = useGLTF('./models/AllColorGLB144/Van_BlueGrey.glb')
...
useGLTF.preload('./models/AllColorGLB144/Van_BlueGrey.glb')