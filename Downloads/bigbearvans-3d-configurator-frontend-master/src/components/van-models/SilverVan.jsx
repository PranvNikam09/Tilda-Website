...
export default function Van_SilverGrey({ hidePartsWhenFacingCamera, showExterior }) {
  const { nodes, materials } = useGLTF('./models/AllColorGLB144/Van_SilverGrey.glb')
...
useGLTF.preload('./models/AllColorGLB144/Van_SilverGrey.glb')