...
export default function Van_White({ hidePartsWhenFacingCamera, showExterior }) {
  const { nodes, materials } = useGLTF("./models/AllColorGLB144/Van_White.glb");
...
useGLTF.preload("./models/AllColorGLB144/Van_White.glb");
